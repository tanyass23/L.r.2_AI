...
Original file is located at
    https://colab.research.google.com/drive/1L2XDGPF5yjz3tttNRSU4lm2ndVaYybfV
...
classifier = SVC(kernel='poly', degree=3, C=1.0, decision_function_shape='ovo')
classifier.fit(X_train, y_train)

y_pred = classifier.predict(X_test)

print("\nОцінка класифікатора (поліноміальне ядро):")
